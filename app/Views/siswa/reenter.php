...
<body>
    <div class="container-fluid position-absolute top-50 start-50 pt-5 ps-5 pe-5 translate-middle login-layer">
        <h2 class="text-center fw-bold">Anda Sudah Pernah Melakukan Tes</h2>
        <?php if (session()->getFlashdata('msg')) : ?>
            <div class="alert alert-danger" id="flashdata"><?= session()->getFlashdata('msg') ?></div>
        <?php endif; ?>
        <div class="mb-3 text-center">
            <h5 class="fw-light">Apakah Anda Ingin Melakukan Tes Lagi?</h5>
        </div>
        <div class="mb-3 text-center">
            <div class="row">
                <div class="col mt-2">
                    <a href="/uji">
                        <button class="btn btn-primary text-center"> Iya </button>
                    </a>
                </div>
                <div class="col mt-2">
                    <a href="/siswa">
                        <button class="btn btn-danger text-center">Tidak</button>
                    </a>
                </div>
            </div>
        </div>
