...
$routes->get('/uji', 'Uji::uji', ['filter' => 'siswa']);
$routes->post('/uji/save', 'Uji::save');
$routes->get('/uji1', 'Uji::uji1');
...
$routes->post('admin/editKelas/(:num)', 'Admin::editKelas/$1');
$routes->get('admin/removeClass/(:num)', 'Admin::removeClass/$1');
$routes->get('admin/viewSiswa/(:segment)', 'Admin::viewSiswa/$1');
